...
<form action="admin.php?page=pn-committee" method="post" enctype="multipart/form-data" id="form-delete">
		<input type="hidden" name="delete" value="" />
</form>
<div id="opacity-edit" style="display:none;"></div>
<div id="edit-window" style="display:none;">
	<form action="admin.php?page=pn-committee" method="post" enctype="multipart/form-data" id="form-edit">
...
<h2>Parse the webservice <a href="admin.php?page=pn-committee&parse=true" class="button parse-new-h2">Execute</a></h2>
<div id="plug-actions"><a href="#add_new" class="button add-new-h2">Add new committee</a></div>
[STRMESSAGE]
<div id="add-list"> 
<form action="admin.php?page=pn-committee" method="post" enctype="multipart/form-data" id="form-submit">
...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody class="">
		<tr>
			<td scope="col" class="manage-column" style="">Committte ID:</td>
			<td scope="col" class="manage-column" style=""><input type="text" name="comm_id"/></td>
			<td scope="col" class="manage-column" style="">Name:</td>
			<td scope="col" class="manage-column" style=""><input type="text" name="name"/></td>
		</tr>
		<tr>
...
<div style="text-align:right;margin-bottom:5px;">
	<form action="admin.php" method="get">
		<input type="hidden" name="page" value="pn-committee"/>
...
<tr class="thead">
	...
	<th scope="col" class="manage-column" style=""><a href="admin.php?page=pn-committee&p=[PAGE]&o=comm_id,[ORDER]&s=[SEARCH]">Committtee ID</a></th>
	<th scope="col" class="manage-column" style=""><a href="admin.php?page=pn-committee&p=[PAGE]&o=name,[ORDER]&s=[SEARCH]">Name</a></th>
	<th scope="col" class="manage-column" style=""><a href="admin.php?page=pn-committee&p=[PAGE]&o=email,[ORDER]&s=[SEARCH]">Email</a></th>
...
<div><a href="#delete" class="button delete-h2">Delete committee</a></div>
</div>
<script type="text/javascript">
	jQuery("table tbody a.edit").click(function () {
		...
		jQuery("#form-edit input[name=comm_id]").val(d.comm_id);
		jQuery("#form-edit input[name=name]").val(d.name);
