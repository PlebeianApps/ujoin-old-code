...
<form action="admin.php?page=pn-categories" method="post" enctype="multipart/form-data" id="form-delete">
...
<div id="edit-window" style="display:none;">
	<form action="admin.php?page=pn-categories" method="post" enctype="multipart/form-data" id="form-edit">
...
<h2>Categories</h2>
<div id="plug-actions"><a href="#add_new" class="button add-new-h2">Add new category</a></div>
[STRMESSAGE]


<div id="add-list"> 
<form action="admin.php?page=pn-categories" method="post" enctype="multipart/form-data" id="form-submit">
...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody class="">
		<tr>
			...
			<td scope="col" id="title" class="manage-column" style=""><input type="text" name="title"/></td>
		</tr>
	</tbody>
</table>
</div>
...
<tr class="thead">
	...
	<th scope="col" class="manage-column" style=""><a href="admin.php?page=pn-categories&o=title,[ORDER]">Title</a></th>
...
<div><a href="#delete" class="button delete-cycle-h2">Delete a category</a></div>
</div>
...
<script type="text/javascript">
	...
	jQuery("a.delete-cat-h2").click(function () {
		var t = new Array();
		jQuery("#table-cats input[type=checkbox]:checked").each(function(){
