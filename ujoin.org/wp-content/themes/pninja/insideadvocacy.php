...
<?php get_header() ?>
	...
	<?php //if ( (is_user_logged_in() || $guest) && !isset($_REQUEST['public'])) { ?>
...
<div id="content-page">              
		...
		<div id="contentLeft">
           ...
           <?PHP endif;?>
            	<li><a href="#" id="editPage">Edit Advocacy Email</a></li>
            	<li><a href="#" id="deleteLetter">Delete Advocacy Email</a></li>
	              <?PHP if(!testimony_exists($form_query['bill'])):?>
	              	<li><a href="<?=home_url('/');?>?page_id=191&template=advocacy&template_id=<?=$letter?>">Duplicate this to: Testimony Action Page</a></li> 
	              <?PHP endif; ?>
	              <?PHP if(!advocacy_exists($form_query['bill'])):?>
	              	<li><a href="<?=home_url('/');?>?page_id=176&template=advocacy&template_id=<?=$letter?>">Duplicate this to: Advocacy Action Page</a></li> 
	              <?PHP endif; ?>
	              <?PHP if(!letter_exists($form_query['bill'])):?>
	              	<li><a href="<?=home_url('/');?>?page_id=172&template=advocacy&template_id=<?=$letter?>">Duplicate this to: Letter Action Page</a></li> 
	              <?PHP endif; ?>
	              <?PHP if(!petition_exists($form_query['bill'])):?>
	              <li><a href="<?=home_url('/');?>?page_id=178&template=advocacy&template_id=<?=$letter?>">Duplicate this to: Petition Action Page</a></li>
	              <?PHP endif; ?>
	              <?PHP else:?>
              	<li><a href="#">
                	<h6>Support Video</h6>
        	...
        	<div id="contentRightTop">
                ...
                <div id="main">
                  ...
                  <ul id="newBill" style="padding:4px 0 0;">
                        ...
                        <li><span class="labelLeft">Video Testimony</span><input <?=get_form_value($form_query, 'youtube');?> id="f-youtube" type="url" size="40" class="text"></li>
                        <li>
...
?>
                        ...
                        <?PHP foreach($letters as $key):?>
							<a href="<?php bloginfo('url');?>/?p=227&letter=<?=$key['id'];?>" class="tabContentRow">
        ...
        <div id="contentRight">
        	...
        	<div id="contentRightTop">
                ...
                <div id="main">
                    ...
                    <h1 style="margin:0;">Your email</h1>                                               
    ...
    theme : 'clean'
                    ...
                    <form id="g-form">
                      <ul id="newBill" style="background:none; margin-top:-28px 10px 0 0;">
                        ...
                        <li><label class="labelLeft">Your email</label><textarea id="g-testimony" cols="40" rows="5"><?=$form_query['message'];?></textarea></li>
