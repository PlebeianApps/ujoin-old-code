        	...
        	<div id="contentRightTop">
                ...
                <div id="main">
                  ...
                  <ul id="newBill" style="padding:4px 0 0;">
                        ...
                        <li>
                       		<label class="labelLeft">Public Action Page? <img src="<?php bloginfo('stylesheet_directory') ?>/images/whatisthis.png" title="If you would like your page to be listed on Hawaii Policy Portal for the general public to view, choose 'yes'.  If you do not want it listed publicly, choose 'no'." /></label>
                       		<select id="f-public">
        ...
        <div id="contentRight">
        	...
        	<div id="contentRightTop">
                ...
                <div id="main">
                    ...
                    <h1>New Letters to the Editor</h1>
                    <p>Please register to be able to create Letters to the Editor</p>
