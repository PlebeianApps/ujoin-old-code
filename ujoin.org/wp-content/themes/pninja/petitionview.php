...
<?PHP
	...
	$sql = "SELECT * FROM $pn_tables->form_user WHERE id = $testimony AND parent_table = 'pn_form_petition';";
   ...
   <div id="contentRight">
        	...
        	<div id="contentRightTop">
            	...
            	?>
                        ...
                        <li>
                            <span class="labelLeft">Description:</span>
