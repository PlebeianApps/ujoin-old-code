...
<?PHP
	...
	$sql = "SELECT * FROM  $pn_tables->form_user WHERE id = $testimony AND parent_table = 'pn_form_letter';";
   ...
   <div id="contentRight">
        	...
        	<div id="contentRightTop">
                ...
                <div id="main">
                	...
                	<h1>Letter to Editor</h1>      
                    <p>Some text talking about the edit page...</p>                                                
                        
                  	<ul id="newBill" style="padding:4px 0 0;">
                        <li>
                            <span class="labelLeft">To:</span>
							<div class="labelRight"><?=$form_query['to'];?></div>
                        </li>                                                  
                        <li>
                            <span class="labelLeft">BCC:</span>
							<div class="labelRight"><?=$form_query['bbc'];?></div>
                        </li>   
                        <li>
                            <span class="labelLeft">Title:</span>
							<div class="labelRight"><?=$form_query['title'];?></div>
                        </li>   
                        <li>
                            <span class="labelLeft">Overview:</span>
							<div class="labelRight"><?=$form_query['overview'];?></div>
                        </li> 
                        <li>
                            <span class="labelLeft">Talking Points:</span>
							<div class="labelRight"><?=$form_query['talking_points'];?></div>
                        </li>
                        <li>
                            <span class="labelLeft">Sample Message:</span>
							<div class="labelRight"><?=$form_query['message'];?></div>
                        </li>   
